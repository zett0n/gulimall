...
public class OrderItemController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        PageUtils page = this.orderItemService.queryPage(params);
    ...
    public R info(@PathVariable("id") Long id) {
        OrderItemEntity orderItem = this.orderItemService.getById(id);
    ...
    public R delete(@RequestBody Long[] ids) {
        this.orderItemService.removeByIds(Arrays.asList(ids));
