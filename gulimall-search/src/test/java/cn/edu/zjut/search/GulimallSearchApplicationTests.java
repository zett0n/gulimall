...
class GulimallSearchApplicationTests {
    ...
    void indexData() throws IOException {
        ...
        // 同步执行
        IndexResponse index = this.client.index(indexRequest, ElasticSearchConfig.COMMON_OPTIONS);
    ...
    void searchData() throws IOException {
        ...
        // 2. 执行检索, 获得响应
        SearchResponse searchResponse = this.client.search(searchRequest, ElasticSearchConfig.COMMON_OPTIONS);
